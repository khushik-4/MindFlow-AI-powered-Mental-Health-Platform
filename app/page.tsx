  ...
  return (
    <div className="flex flex-col min-h-screen overflow-hidden">
        ...
        >
          ...
          >
            <Button
              ...
              className="relative group h-12 px-8 rounded-full bg-primary hover:bg-primary/90 shadow-lg shadow-primary/20 transition-all duration-300"
            >
      ...
      <Dialog open={showDialog} onOpenChange={setShowDialog}>
        <DialogContent className="sm:max-w-[425px] bg-card border border-primary/20 shadow-2xl shadow-primary/5 rounded-2xl p-6">
          <DialogHeader>
            <motion.div
              key={currentStep}
              initial={{ opacity: 0, y: 20 }}
          ...
          <div className="flex justify-between items-center mt-8">
            <div className="flex gap-2">
              {welcomeSteps.map((_, index) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all duration-300 focus:outline-none ${index === currentStep
                    ? "bg-primary w-6"
            ...
            <Button
              ...
              className="relative group px-6 bg-gradient-to-r from-primary to-primary/80 hover:from-primary/95 hover:to-primary/75 text-primary-foreground font-medium shadow-md transition-all duration-300"
            >
