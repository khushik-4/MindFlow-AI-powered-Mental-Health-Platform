...
const features = [
  ...
  },
  {
    ...
    description:
      "Your therapy sessions are protected with secure encryption and transparent access controls.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Detailed analytics and insights about your mental health journey, with secure session records.",
  },
  {
    icon: <Fingerprint className="w-10 h-10 text-primary" />,
    title: "Privacy First",
    description:
      "End-to-end encryption and strong privacy controls ensure your data remains completely confidential.",
  },
  {
